...
from .utils import console, PROJECT_ROOT, get_file_selection, find_config_files, find_aux_files, find_schema_files, get_available_adapters, PathValidator
...
def configuration_workflow(organism: str) -> Optional[Dict[str, Union[str, List[str]]]]:
    ...
    schema_files = find_schema_files(organism)
    selections = {}
    ...
    while True:
        ...
        if result is None: continue
        selections["--schema-config"] = result; break
